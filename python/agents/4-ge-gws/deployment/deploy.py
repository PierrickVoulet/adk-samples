...
"""Deployment script for Enterprise Search."""
...
from ge_gws.agent import root_agent
import vertexai
...
def create() -> None:
    """Creates an agent engine for Enterprise Search."""
    ...
    remote_agent = agent_engines.create(
        ...
        extra_packages=["./ge_gws"],
    )
    print(f"Created remote agent: {remote_agent.resource_name}")


def update(resource_id: str) -> None:
    """Updates an agent engine for Enterprise Search."""
    adk_app = AdkApp(agent=root_agent, enable_tracing=True)
