...
"""Deployment script for city profile agent."""
...
from city_profile.agent import root_agent
import vertexai
...
def create() -> None:
    """Creates an agent engine for City Profile."""
    ...
    remote_agent = agent_engines.create(
        ...
        extra_packages=["./city_profile"],
    )
    print(f"Created remote agent: {remote_agent.resource_name}")


def update(resource_id: str) -> None:
    """Updates an agent engine for City Profile."""
    adk_app = AdkApp(agent=root_agent, enable_tracing=True)
